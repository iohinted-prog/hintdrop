...
export const REGIONS = {
  ...
  us: {
    ...
    label: "US",
    currency: "USD",
    // MX and CA get routed here too, rather than falling through to
    // the UK default - USD pricing from US retailers is a much closer
    // match for either than GBP is, even without a dedicated MX/CA
    // catalog of their own yet.
    countries: ["US", "MX", "CA"],
  },
};
