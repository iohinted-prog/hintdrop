...
export function buildHintInsertPayload(product, userId, fallbackCurrency) {
  ...
  const resolvedCurrency =
    detectCurrency(product?.price_text) ||
    product?.currency ||
    fallbackCurrency ||
    ACTIVE_CURRENCY;
  ...
  return {
    ...
    pricetext: formatPriceLabel(parsedNumericPrice, product?.price_text, resolvedCurrency),
