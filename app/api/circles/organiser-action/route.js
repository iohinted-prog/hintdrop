...
export async function GET(request) {
  ...
  if (!circle) {
    return new Response('<html><body style="font-family:sans-serif;padding:40px;text-align:center"><h2>Invalid or expired link</h2><p><a href="https://hintdrop.app/circles">Go to HintDrop</a></p></body></html>', { status: 403, headers: { 'Content-Type': 'text/html' } })
  }
