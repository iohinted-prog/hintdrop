    ...
    if (ownerEmail) {
      await sendEmail({
        ...
        html: `<div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px">
          <div style="text-align:center;margin-bottom:20px"><img src="https://hintdrop.app/illustrations/logo-coral-full.png" alt="HintDrop" height="64" style="display:inline-block;height:64px;width:auto" /></div>
